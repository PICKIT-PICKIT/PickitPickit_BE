...
public enum SuccessStatus {
    ...
    // ================= User =================
    USER_INFO_SUCCESS(HttpStatus.OK, "USER_INFO_SUCCESS", "유저 정보 조회 성공"),
    USER_UPDATE_SUCCESS(HttpStatus.OK, "USER_UPDATE_SUCCESS", "프로필 수정 성공"),
    USER_SETTING_UPDATE_SUCCESS(HttpStatus.OK, "USER_SETTING_UPDATE_SUCCESS", "설정 변경 성공"),
